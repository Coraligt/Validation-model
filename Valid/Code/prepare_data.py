...
def preprocess_dataset(data_dir, output_dir, train_indices_file, use_columns=['t', 'q']):
    ...
    # Just normalize the training data, also since we only use the q column, we just use the q column
    train_files = []
...
def prepare_data(data_dir, output_dir, test_ratio=0.15, seed=42):
    """
    ...
    # Step 2: Create train/test indices
    create_indices_files(data_dir, output_dir, test_ratio, seed)
...
if __name__ == '__main__':
    ...
    prepare_data(args.data_dir, args.output_dir, args.test_ratio, args.seed)